...
def labels_to_class_weights(labels, nc=80):
    ...
    # Prevents single-class dominant, also helps with class imbalance
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        if x.shape[0]:
            ...
            if merge and (1 < n < 3E3):  # Merge NMS (boxes merged using weighted mean)
                ...
                except:  # possible CUDA error https://github.com/ultralytics/yolov5/issues/5889
                    print(f'WARNING: NMS merge failed')
            output[xi] = x[i]
